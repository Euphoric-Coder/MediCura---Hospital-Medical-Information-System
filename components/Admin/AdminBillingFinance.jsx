        ...
        <div className="p-4 sm:p-6 lg:p-8">
          ...
          <div className="bg-gradient-to-r from-blue-500/10 to-blue-600/5 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-4 sm:p-6 mb-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <h3 className="text-16-bold text-white mb-3">
                  Invoice Information
                </h3>
                <div className="space-y-2 text-14-regular text-dark-700">
                  <p>
                    <span className="text-white">Invoice ID:</span> {invoice.id}
                  </p>
                  <p>
              ...
              <div>
                ...
                <div className="space-y-2 text-14-regular text-dark-700">
                  ...
                  <p>
                    <span className="text-white">Patient Pays:</span> $
          ...
          <div className="bg-dark-500/30 rounded-2xl p-4 sm:p-6 mb-6">
            ...
            <div className="space-y-3">
              {invoice.services.map((service, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between bg-dark-400/50 rounded-lg p-3"
                >
          ...
          {invoice.status === "draft" && (
            <div className="bg-yellow-500/10 rounded-2xl p-4 sm:p-6 mb-6">
              <h3 className="text-16-bold text-white mb-4">
...
const AdminBillingFinance = ({ onBack }) => {
  const [invoices, setInvoices] = useState([
    ...
    },
    {
      ...
      insuranceCovered: 416.0,
      patientResponsibility: 104.0,
    },
    {
      id: "INV-2024-003",
  ...
  const generateFinancialReport = () => {
    ...
    doc.text("Phone: (555) 123-4567 | Email: billing@medicura.com", 20, 50);
  ...
  const handleApproveInvoice = (invoiceId) => {
    ...
    setMessage(
      `Invoice ${invoiceId} approved and sent to ${invoice?.patientName}`
    );
            ...
            {filteredInvoices.length === 0 && (
              <div className="text-center py-12 lg:py-20">
                ...
                <p className="text-14-regular lg:text-16-regular text-dark-700 max-w-md mx-auto">
                  No invoices match your search criteria. Try adjusting your
                  filters.
                </p>
              </div>
            )}
