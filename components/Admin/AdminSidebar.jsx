  ...
  const menuItems = [
    {
      ...
      label: "Dashboard",
      icon: Home,
      description: "Hospital Overview & Analytics",
    },
    {
      id: "staff-management",
      label: "Staff Management",
      icon: Users,
      description: "Manage Doctors, Pharmacists, Staff",
    },
    {
      id: "patient-oversight",
      label: "Patient Oversight",
      icon: UserPlus,
      description: "Monitor Patients & Appointments",
    },
    {
      id: "inventory-tracking",
      label: "Inventory Tracking",
      icon: Package,
      description: "Medicines, Supplies & Equipment",
    },
    {
      id: "billing-finance",
    ...
    },
    {
      ...
      icon: BarChart3,
      description: "Hospital Metrics & Insights",
    },
    {
      id: "user-management",
      ...
      >
        ...
        <div className="p-4 lg:p-6 border-b border-dark-500/50">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-red-500 to-red-600 rounded-2xl flex items-center justify-center shadow-lg">
          ...
          {/* Admin Info */}
          <div className="bg-gradient-to-r from-red-500/10 to-red-600/5 backdrop-blur-sm border border-red-500/20 rounded-2xl p-4">
