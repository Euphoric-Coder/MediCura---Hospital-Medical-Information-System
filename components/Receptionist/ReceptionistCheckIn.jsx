      ...
      case 'waiting':
        return (
          <div className="flex items-center gap-2 px-3 py-1 bg-yellow-500/20 border border-yellow-500/30 rounded-full">
            ...
            <span className="text-10-medium sm:text-12-medium text-yellow-400">Waiting</span>
          </div>
        );
      case 'arrived':
        return (
          <div className="flex items-center gap-2 px-3 py-1 bg-blue-500/20 border border-blue-500/30 rounded-full">
            ...
            <span className="text-10-medium sm:text-12-medium text-blue-400">Arrived</span>
          </div>
        );
      case 'checked-in':
        return (
      ...
      <div className="bg-dark-200/80 backdrop-blur-xl border-b border-dark-500/50 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-20-bold lg:text-24-bold text-white">Patient Check-In</span>
              <p className="text-12-regular lg:text-14-regular text-dark-700">Manage patient arrivals and check-ins</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-6 lg:py-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-6 lg:mb-8">
          ...
          <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/5 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-4 lg:p-6">
            <div className="flex items-center gap-3 lg:gap-4">
              ...
              <div>
                <div className="text-20-bold lg:text-32-bold text-white">{arrivedCount}</div>
                <div className="text-10-regular lg:text-14-regular text-blue-400">Arrived</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/5 backdrop-blur-sm border border-purple-500/20 rounded-2xl p-4 lg:p-6">
            <div className="flex items-center gap-3 lg:gap-4">
              ...
              <div>
                <div className="text-20-bold lg:text-32-bold text-white">{inConsultationCount}</div>
                <div className="text-10-regular lg:text-14-regular text-purple-400">In Consultation</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-dark-400/30 to-dark-300/30 backdrop-blur-xl border border-dark-500/50 rounded-3xl p-4 lg:p-8">
          <div className="flex items-center gap-3 mb-6 lg:mb-8">
            ...
            <h2 className="text-18-bold lg:text-24-bold text-white">Today's Check-Ins</h2>
          </div>
                  ...
                  <div className="flex items-center gap-4 lg:gap-6">
                    ...
                    <div className="space-y-2 min-w-0 flex-1">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 text-12-regular lg:text-14-regular text-dark-700">
                        ...
                        {patient.arrivalTime && (
                          <div>
                            <span className="text-white">Arrived:</span> {patient.arrivalTime}
                          </div>
                        )}
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 text-12-regular lg:text-14-regular text-dark-700">
                        <div>
                          <span className="text-white">Doctor:</span> {patient.doctor}
                        </div>
                        <div>
                          <span className="text-white">Type:</span> {patient.type}
                        </div>
                        <div>
                      ...
                      <div className="bg-purple-500/20 rounded-lg px-3 py-2">
                        <p className="text-10-regular lg:text-12-regular text-purple-400">
                          <span className="text-white">Reason:</span> {patient.reason}
                        </p>
                      </div>
          ...
          {filteredPatients.length === 0 && (
            <div className="text-center py-12 lg:py-20">
              ...
              <p className="text-14-regular lg:text-16-regular text-dark-700 max-w-md mx-auto">
                No patients match your search criteria or all patients have been processed.
              </p>
            </div>
          )}
        </div>
