...
import { Plus, Package, Search, Edit, Trash2, AlertTriangle, CheckCircle, Calendar, TrendingUp, TrendingDown, X } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setMedicineData(prev => ({ ...prev, category: e.target.value }))}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setMedicineData(prev => ({ ...prev, manufacturer: e.target.value }))}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setMedicineData(prev => ({ ...prev, batchNumber: e.target.value }))}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setMedicineData(prev => ({ ...prev, expiryDate: e.target.value }))}
                  className="shad-input w-full text-white"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setMedicineData(prev => ({ ...prev, location: e.target.value }))}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setMedicineData(prev => ({ ...prev, quantity: parseInt(e.target.value) || 0 }))}
                  placeholder="0"
                  className="shad-input w-full text-white"
                  required
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setMedicineData(prev => ({ ...prev, minStockLevel: parseInt(e.target.value) || 0 }))}
                  placeholder="0"
                  className="shad-input w-full text-white"
                  required
                />
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  onChange={(e) => setMedicineData(prev => ({ ...prev, unitPrice: parseFloat(e.target.value) || 0 }))}
                  placeholder="0.00"
                  className="shad-input w-full text-white"
                  required
                />
      ...
      case 'in-stock':
        return (
          <div className="flex items-center gap-2 px-3 py-1 bg-green-500/20 border border-green-500/30 rounded-full">
            ...
            <span className="text-10-medium sm:text-12-medium text-green-400">In Stock</span>
          </div>
        );
      case 'low-stock':
        return (
          <div className="flex items-center gap-2 px-3 py-1 bg-yellow-500/20 border border-yellow-500/30 rounded-full">
            ...
            <span className="text-10-medium sm:text-12-medium text-yellow-400">Low Stock</span>
          </div>
        );
      case 'out-of-stock':
        return (
          <div className="flex items-center gap-2 px-3 py-1 bg-red-500/20 border border-red-500/30 rounded-full">
            ...
            <span className="text-10-medium sm:text-12-medium text-red-400">Out of Stock</span>
          </div>
        );
      case 'expired':
        return (
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-20-bold lg:text-24-bold text-white">Medicine Inventory</span>
                  <p className="text-12-regular lg:text-14-regular text-dark-700">Manage medicine stock</p>
                </div>
              </div>
              <button
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-6 lg:mb-8">
            <div className="bg-gradient-to-br from-green-500/10 to-green-600/5 backdrop-blur-sm border border-green-500/20 rounded-2xl p-4 lg:p-6">
              <div className="flex items-center gap-3 lg:gap-4">
                ...
                <div>
                  <div className="text-20-bold lg:text-32-bold text-white">{inStockCount}</div>
                  <div className="text-10-regular lg:text-14-regular text-green-400">In Stock</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-yellow-500/10 to-yellow-600/5 backdrop-blur-sm border border-yellow-500/20 rounded-2xl p-4 lg:p-6">
              <div className="flex items-center gap-3 lg:gap-4">
                ...
                <div>
                  ...
                  <div className="text-10-regular lg:text-14-regular text-yellow-400">Low Stock</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-500/10 to-red-600/5 backdrop-blur-sm border border-red-500/20 rounded-2xl p-4 lg:p-6">
              <div className="flex items-center gap-3 lg:gap-4">
                ...
                <div>
                  <div className="text-20-bold lg:text-32-bold text-white">{outOfStockCount}</div>
                  <div className="text-10-regular lg:text-14-regular text-red-400">Out of Stock</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-500/10 to-gray-600/5 backdrop-blur-sm border border-gray-500/20 rounded-2xl p-4 lg:p-6">
              <div className="flex items-center gap-3 lg:gap-4">
                ...
                <div>
                  <div className="text-20-bold lg:text-32-bold text-white">{expiredCount}</div>
                  <div className="text-10-regular lg:text-14-regular text-gray-400">Expired</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-dark-400/30 to-dark-300/30 backdrop-blur-xl border border-dark-500/50 rounded-3xl p-4 lg:p-8">
            <div className="flex items-center gap-3 mb-6 lg:mb-8">
              ...
              <h2 className="text-18-bold lg:text-24-bold text-white">Medicine Inventory</h2>
            </div>

            <div className="space-y-4">
              {filteredMedicines.map((medicine) => (
                <div key={medicine.id} className="bg-gradient-to-r from-dark-300/50 to-dark-400/30 backdrop-blur-sm border border-dark-500/50 rounded-2xl p-4 lg:p-6 hover:border-dark-500/80 transition-all duration-300">
                    ...
                    <div className="flex items-center gap-4 lg:gap-6">
                      ...
                      <div className="space-y-3 min-w-0 flex-1">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                          <h3 className="text-16-bold lg:text-20-bold text-white">{medicine.name}</h3>
            ...
            {filteredMedicines.length === 0 && (
              <div className="text-center py-12 lg:py-20">
                ...
                <h3 className="text-20-bold lg:text-24-bold text-white mb-4">No medicines found</h3>
