  ...
  const menuItems = [
    {
      ...
      label: "Dashboard",
      icon: Home,
      description: "Overview & Daily Summary",
    },
    {
      id: "prescriptions",
      label: "Prescriptions",
      icon: Pill,
      description: "Verify & Dispense Medications",
    },
    {
      id: "inventory",
      label: "Inventory",
  ...
  const quickActions = [
    {
      ...
      icon: AlertTriangle,
      color: "bg-red-500",
      description: "Priority Prescriptions",
    },
    {
      id: "low-stock",
      ...
      >
        ...
        <div className="p-4 lg:p-6 border-b border-dark-500/50">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg">
          ...
          {/* Pharmacist Info */}
          <div className="bg-gradient-to-r from-blue-500/10 to-blue-600/5 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-4">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 lg:w-10 lg:h-10 bg-gradient-to-r from-green-500 to-purple-600 rounded-xl flex items-center justify-center">
