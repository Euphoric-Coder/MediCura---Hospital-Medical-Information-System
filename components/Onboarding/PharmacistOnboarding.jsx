        ...
        <div className="sub-container max-w-4xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-12">
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      placeholder="123 Pharmacy Street, City, State 12345"
                      className="shad-input pl-10 w-full text-white"
                      required
                    />
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="max-h-60 overflow-y-auto">
                          {pharmacyTypes.map((type) => (
                            <button
                              key={type}
                              type="button"
                              onClick={() => handlePharmacyTypeSelect(type)}
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="CVS Pharmacy, Walgreens, etc."
                    className="shad-input w-full text-white"
                    required
                  />
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    placeholder="Clinical pharmacy, oncology, pediatrics, geriatrics, etc."
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      placeholder="University of California School of Pharmacy"
                      className="shad-input pl-10 w-full text-white"
                      required
                    />
                  </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="PGY1 Pharmacy Residency - Mayo Clinic"
                    className="shad-input w-full text-white"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    placeholder="Immunizations, medication therapy management, health screenings, etc."
                    className="shad-textArea w-full text-white min-h-[100px] resize-none"
                    rows={4}
                  />
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    placeholder="Experience with Medicare, Medicaid, private insurance, prior authorizations, etc."
                    className="shad-textArea w-full text-white min-h-[100px] resize-none"
                    rows={4}
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="file-upload">
                    <input
                      ...
                      className="hidden"
                    />
                    <label htmlFor="deaLicense" className="cursor-pointer">
                      <div className="flex flex-col items-center gap-3">
              ...
              <div className="space-y-6">
                <label className="flex items-start gap-3 cursor-pointer">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-5 h-5 mt-0.5 text-blue-500 bg-dark-400 border-dark-500 rounded focus:ring-blue-500"
                    required
                  />
                  <span className="text-14-regular text-white">
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                  <input
                    type="checkbox"
                    name="regulatoryConsent"
                    checked={formData.regulatoryConsent}
                    onChange={handleInputChange}
                    className="w-5 h-5 mt-0.5 text-blue-500 bg-dark-400 border-dark-500 rounded focus:ring-blue-500"
                    required
                  />
            ...
            <div className="pt-8">
              <button
                type="submit"
                className="w-full bg-blue-500 hover:bg-blue-600 text-white py-4 px-6 rounded-lg text-16-semibold transition-colors"
              >
