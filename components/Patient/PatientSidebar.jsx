    ...
    <>
      ...
      <div className="p-4 lg:p-6 border-b border-dark-500/50">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-16-bold lg:text-20-bold text-white">Patient Portal</h2>
            <p className="text-10-regular lg:text-12-regular text-dark-700">Your Health Dashboard</p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-500/10 to-green-600/5 backdrop-blur-sm border border-green-500/20 rounded-2xl p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-14-semibold lg:text-16-semibold text-white">John Smith</h3>
              <p className="text-10-regular lg:text-12-regular text-green-400">Patient ID: P001</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-3 lg:p-4">
            ...
            >
              <div className={`w-8 h-8 lg:w-10 lg:h-10 rounded-xl flex items-center justify-center transition-all duration-300 ${
                ...
                <item.icon className={`w-4 h-4 lg:w-5 lg:h-5 ${
                  currentPage === item.id ? 'text-white' : 'text-dark-600 group-hover:text-white'
                }`} />
              </div>
              <div className="flex-1">
                <div className={`text-12-semibold lg:text-14-semibold ${
                  currentPage === item.id ? 'text-white' : 'group-hover:text-white'
                }`}>
                  {item.label}
                </div>
                <div className={`text-10-regular lg:text-12-regular hidden sm:block ${
                  currentPage === item.id ? 'text-white/70' : 'text-dark-600 group-hover:text-dark-600'
                }`}>
                  {item.description}
                </div>
              </div>
        ...
        <div className="mt-8 space-y-2">
          ...
          {quickActions.map((action) => (
            ...
            >
              <div className={`w-8 h-8 lg:w-10 lg:h-10 ${action.color} rounded-xl flex items-center justify-center shadow-lg`}>
      ...
      <div className="p-3 lg:p-4 border-t border-dark-500/50 space-y-2">
        ...
        >
          ...
          <div className="flex-1">
            <div className="text-12-semibold lg:text-14-semibold group-hover:text-white">Settings</div>
            <div className="text-10-regular lg:text-12-regular text-dark-600 group-hover:text-dark-600 hidden sm:block">App Preferences</div>
          </div>
        </button>
        ...
        >
          ...
          <div className="flex-1">
            <div className="text-12-semibold lg:text-14-semibold">Sign Out</div>
            <div className="text-10-regular lg:text-12-regular text-red-400/70 hidden sm:block">Exit Patient Portal</div>
          </div>
        </button>
      </div>
      </div>
