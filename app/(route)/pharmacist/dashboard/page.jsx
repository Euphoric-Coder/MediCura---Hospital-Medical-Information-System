...
import { Pharmacists, Users } from "@/lib/schema";
      ...
      try {
        ...
        if (data.length > 0) {
          ...
          if (pharmacist.length > 0) {
            console.log("Pharmacist data:", pharmacist[0]);
            setPharmacistData(pharmacist[0]);
            setOnboardingStatus(pharmacist[0].hasOnboarded);
          }
        }
      } catch (error) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-dark-300">
        <div className="flex flex-col items-center">
          ...
          <p className="text-white text-lg animate-pulse">Loading Pharmacist Dashboard...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-dark-300 via-dark-200 to-dark-400 p-6">
        <div className="bg-dark-400/70 border border-red-500/30 rounded-3xl p-8 max-w-md w-full text-center shadow-lg">
          ...
          <p className="text-dark-600 text-16-regular mb-6">
            ...
            don’t have access to the Pharmacist Dashboard. Please proceed to your{" "}
