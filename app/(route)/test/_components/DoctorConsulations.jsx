...
const DoctorConsultations = ({ onBack }) => {
  ...
  const handleSaveConsultation = () => {
    // In a real app, this would save to the database and link to patient records
    const consultationDataToSave = {
      ...
      diagnosis: consultationData.assessment,
      consultationNotes: `Chief Complaint: ${consultationData.chiefComplaint}\n\nHistory: ${consultationData.historyOfPresentIllness}\n\nExamination: ${consultationData.physicalExamination}\n\nAssessment: ${consultationData.assessment}\n\nPlan: ${consultationData.plan}`,
      prescriptions: consultationData.prescriptions.map(prescription => ({
        ...prescription,
        consultationId: `cons-${Date.now()}`,
        appointmentDate: new Date().toISOString().split('T')[0],
        reason: consultationData.chiefComplaint || 'General consultation'
      })),
      labTests: consultationData.labTests,
      requiresAdmission: consultationData.admissionRequired,
      admissionType: consultationData.admissionRequired ? consultationData.admissionType : null,
      admissionReason: consultationData.admissionRequired ? consultationData.admissionReason : null,
      followUpDate: consultationData.nextAppointment || null
    };
    
    console.log('Consultation saved:', consultationDataToSave);
              ...
              <div className="space-y-6 lg:space-y-8">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`py-3 px-6 rounded-xl text-16-semibold transition-all duration-300 shadow-lg flex items-center justify-center gap-2 ${
                      consultationSaved 
