    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-dark-300 via-dark-200 to-dark-400">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-6 lg:py-8">
          ...
          {prescriptions.consultationDate && (
            <div className="bg-gradient-to-r from-blue-500/10 to-blue-600/5 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-6 mb-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl flex items-center justify-center">
                  <Stethoscope className="w-5 h-5 text-white" />
                </div>
                <h4 className="text-16-bold lg:text-18-bold text-white">Consultation Details</h4>
              </div>
              <div className="space-y-2 text-14-regular text-dark-700">
                <div>
                  <span className="text-white">Consultation Date:</span> {prescription.consultationDate}
                </div>
                <div>
                  <span className="text-white">Reason:</span> {prescription.consultationReason}
                </div>
                <div>
                  <span className="text-white">Diagnosis:</span> {prescription.diagnosis}
                </div>
              </div>
            </div>
          )}
